...
3. *xinit*, initial configuration, an *nobj* by *ndim* matrix.
4. *weighted*, TRUE/FALSE for weighted/unweighted least squares.
5. *ordinal*, FALSE or 0 for numerical, 1,2,3 for ordinal.
7. *itmax*, maximum number of iterations.
8. *eps*, if loss changes less than *eps*, stop.
9. *digits*
10. *width*
11. *verbose*, TRUE/FALSE print iteration info to *stdout*.
